...
import org.bimserver.emf.GenerateGeometryResult;
...
public class InputStreamBasedOfflineGeometryGenerator {

    private static final Logger LOGGER = LoggerFactory.getLogger(InputStreamBasedOfflineGeometryGenerator.class);
    ...
    public InputStreamBasedOfflineGeometryGenerator(IfcModelInterface model, InputStream in, RenderEngine renderEngine) {
        this.model = model;
...
//				}
                ...
                LOGGER.error("", e);
            } catch (BimserverDatabaseException ex) {
                LOGGER.error("", ex);
